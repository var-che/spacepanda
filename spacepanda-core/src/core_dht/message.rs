...
pub enum DhtMessage {
    ...
    Ping { sender_id: DhtKey, timestamp: u64 },

    /// Pong response - acknowledge ping
    Pong { sender_id: DhtKey, timestamp: u64 },

    /// Find node request - lookup k closest nodes to target
    FindNode { sender_id: DhtKey, target: DhtKey, request_id: u64 },

    /// Find node response - return closest known nodes
    FindNodeResponse { sender_id: DhtKey, nodes: Vec<PeerInfo>, request_id: u64 },

    /// Find value request - lookup value by key
    FindValue { sender_id: DhtKey, key: DhtKey, request_id: u64 },

    /// Find value response - return value or closest nodes
    FindValueResponse { sender_id: DhtKey, request_id: u64, result: FindValueResult },

    /// Store value request - store key-value pair
    Store { sender_id: DhtKey, key: DhtKey, value: DhtValue, request_id: u64 },

    /// Store acknowledgment - confirm storage
    StoreAck { sender_id: DhtKey, success: bool, request_id: u64, error: Option<String> },
}
...
mod tests {
    ...
    fn test_find_node() {
        ...
        let msg = DhtMessage::FindNode { sender_id: sender, target, request_id: 123 };
    ...
    fn test_find_value() {
        ...
        let msg = DhtMessage::FindValue { sender_id: sender, key, request_id: 456 };
    ...
    fn test_find_value_response_not_found() {
        ...
        let msg = DhtMessage::FindValueResponse {
            sender_id: sender,
            request_id: 456,
            result: FindValueResult::NotFound { closest_nodes: vec![peer1] },
        };
    ...
    fn test_store() {
        ...
        let msg = DhtMessage::Store { sender_id: sender, key, value, request_id: 789 };
    ...
    fn test_store_ack_success() {
        ...
        let msg =
            DhtMessage::StoreAck { sender_id: sender, success: true, request_id: 789, error: None };
