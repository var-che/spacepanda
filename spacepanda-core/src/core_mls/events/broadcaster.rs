...
mod tests {
    ...
    async fn test_subscribe_and_receive() {
        ...
        let event = MlsEvent::GroupCreated { group_id: vec![1, 2, 3], creator_id: vec![4, 5, 6] };
    ...
    async fn test_multiple_subscribers() {
        ...
        let event = MlsEvent::EpochChanged { group_id: vec![1, 2, 3], old_epoch: 0, new_epoch: 1 };
    ...
    async fn test_emit_many() {
        ...
        let events = vec![
            MlsEvent::GroupCreated { group_id: vec![1], creator_id: vec![2] },
            MlsEvent::EpochChanged { group_id: vec![1], old_epoch: 0, new_epoch: 1 },
    ...
    async fn test_no_subscribers() {
        ...
        let event = MlsEvent::GroupCreated { group_id: vec![1], creator_id: vec![2] };
