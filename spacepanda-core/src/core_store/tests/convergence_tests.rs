...
use crate::core_store::model::types::{
    ChannelId, SpaceId, UserId, ChannelType, Timestamp, PermissionLevel
};
use crate::core_store::crdt::{LWWRegister, VectorClock, AddId, Crdt};
    ...
    fn test_full_channel_replica_convergence() {
        ...
        replica1.name.set("Updated Name 1".to_string(), ts_base + 100, "node1".to_string(), vc1.clone());
        replica2.name.set("Updated Name 2".to_string(), ts_base + 200, "node2".to_string(), vc2.clone());
