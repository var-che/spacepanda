...
impl IdentityMeta {
    ...
    pub fn new(identity_id: String, public_key: Vec<u8>, scope: IdentityScope) -> Self {
...
impl IdentityManager {
    ...
    pub fn new() -> Self {
        IdentityManager { identities: HashMap::new(), primary_identity: None }
    }
    ...
    pub fn get_primary(&self) -> Option<&IdentityMeta> {
        self.primary_identity.as_ref().and_then(|id| self.identities.get(id))
    }
...
mod tests {
    ...
    fn test_identity_creation() {
        let identity = IdentityMeta::new_global("id123".to_string(), vec![1, 2, 3]);
    ...
    fn test_leaf_index_management() {
        let mut identity = IdentityMeta::new_global("id123".to_string(), vec![1, 2, 3]);
    ...
    fn test_identity_manager() {
        ...
        let identity1 = IdentityMeta::new_global("id1".to_string(), vec![1, 2, 3]);

        let identity2 = IdentityMeta::new_per_channel("id2".to_string(), vec![4, 5, 6]);
    ...
    fn test_throwaway_identity_expiration() {
        let mut identity = IdentityMeta::new_throwaway("throwaway".to_string(), vec![1, 2, 3]);
    ...
    fn test_cleanup_expired() {
        ...
        let mut throwaway = IdentityMeta::new_throwaway("throwaway".to_string(), vec![1, 2, 3]);
        throwaway.last_used = 0; // Very old

        let global = IdentityMeta::new_global("global".to_string(), vec![4, 5, 6]);
